...
* [`Distance`](xref:Stride.BepuPhysics.HitInfo.Distance) - the actual distance the ray travelled multiplied by it's direction amplitude (Distance = directionLength * actualDistance).
