...
* [**Raycast**](raycasts.md) - fires a ray from a point in a specified direction and retrieves the object(s) it hits.
* [**Sweepcasts**](sweepcasts.md) - fires a shape in a specified direction and retrieves the object(s) it hits.
* [**Overlap**](overlaps.md) - retrieves the objects that overlap a specified area.
