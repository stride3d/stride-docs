...
![](media/edit-history.webp)

The **💾 save icon** appears next to the item that is currently saved on disk. When going to **File > Save** or pressing **Ctrl + S**, the icon will be moved to the latest item.
