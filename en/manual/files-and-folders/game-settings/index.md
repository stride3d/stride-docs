...
In case the game settings asset is missing, Stride will continue to run using default settings. This is what happens when developing games using the [code-only](https://stride3d.github.io/stride-community-toolkit/manual/code-only/index.html) approach.
...
You can access game settings using the service system, or alternatively by accessing the [`Game`](xref:Stride.Engine.Game) class.
