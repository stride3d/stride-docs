...
We're open to bug fixes or new features, the [issues tab on github](https://github.com/stride3d/stride/issues) show a couple of areas that could be improved if you're not sure what you want to work on, some of them already have [bounties associated to them](https://github.com/stride3d/stride/labels/bounty).
For bugs that have not been filed yet, issues without bounties, or if the bounty is not satisfactory, let us know the amount you would want for it when contacting us.
