...
To edit the website through Visual Studio, open the `Stride.Web.slnx` solution, which will load the website in the IDE. You can then modify the pages and content and run the website directly from Visual Studio.

[!IMPORTANT]
Run the website with the **Kestrel** profile. Local IIS/IIS Express is currently not working correctly for this project.
